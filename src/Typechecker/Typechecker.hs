...
inferLiteral _ = throwError "Unboxed literals not supported"
...
inferExpression (HsVar name) = do
    ...
    Qualified quals t <- instantiateType uninstType
    return (quals, t)
...
inferExpression _ = throwError "Unsupported expression"