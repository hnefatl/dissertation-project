...
test = testGroup "Renamer"
    ...
    , makeTest "x = 2\n[a,2,c] = [1,x,3]" "v2 = 2\n[v0,2,v1] = [1,v2,3]"
    , makeTest "_ = let {x=0;y=1;z=2} in if x then y else z" "_ = let {v0=0;v1=1;v2=2} in if v0 then v1 else v2"
    , makeTest "_ = \\x -> x" "_ = \\v0 -> v0"
    , makeTest "_ = let { x = 0 ; y = (\\x -> x) } in y" "_ = let { v0 = 0 ; v1 = (\\v2 -> v2) } in v1"
    ]